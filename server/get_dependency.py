...
#        names = self.DEPDIR + self.RUN_DEPENDENCY_PHYSICAL, self.DEPDIR + self.ON_DEPENDENCY_PHYSICAL
        deps = {}
        deps = self.get_phys_run_dep()
        deps.update( self.get_phys_on_dep() )
#        for name in names:
#        for name in self.RUN_DEPS_PHYS + self.ON_DEPS_PHYS:
...
#        names = self.DEPDIR + self.RUN_DEPENDENCY_SERVICE, self.DEPDIR + self.ON_DEPENDENCY_SERVICE
        deps = {}
        deps = self.get_serv_run_dep()
        deps.update( self.get_serv_on_dep() )
#        for name in names:
#        for name in self.RUN_DEPS_SERV + self.ON_DEPS_SERV:
#            deps.update(self.get_serv_dep(name))
    ...
    def get_phys_run_dep(self):
        ...
        return deps    
#        return self.get_phys_dep(self.DEPDIR + self.RUN_DEPENDENCY_PHYSICAL)
    ...
    def get_serv_run_dep(self):
        ...
        return deps    
#        return self.get_serv_dep(self.DEPDIR + self.RUN_DEPENDENCY_SERVICE)
    ...
    def get_phys_off_dep(self):
        ...
        return deps    
#        return self.get_phys_dep(self.DEPDIR + self.OFF_DEPENDENCY_PHYSICAL)
    ...
    def get_serv_off_dep(self):
        ...
        return deps    
#        return self.get_serv_dep(self.DEPDIR + self.OFF_DEPENDENCY_SERVICE)
...
#        print self.RUN_DEPS_PHYS 
#        print self.RUN_DEPS_SERV 
#        print self.ON_DEPS_PHYS  
#        print self.ON_DEPS_SERV  
#        print self.OFF_DEPS_PHYS 
#        print self.OFF_DEPS_SERV
